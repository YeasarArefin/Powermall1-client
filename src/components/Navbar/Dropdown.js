...
const Dropdown = ({ handleLogout}) => {
    ...
    const menus = [
        {id:1, name: 'Profile', link: '/profile',icon: <FaUserCircle className='text-xl text-gray-500'/>},
        { id: 2, name: 'My Order', link: '/myorder', icon: <MdShoppingBag className='text-xl text-gray-500'/>},
