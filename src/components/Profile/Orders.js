...
const Orders = () => {
    ...
    const handleRefund = (id) => {
        ...
        axios.put(`https://elec-shop-server.herokuapp.com/orders/${id}`, { refund: 'pending' })
            .then(res => {
                if (res.data.modifiedCount > 0) {

                    axios.get(`https://elec-shop-server.herokuapp.com/orders/${id}`)
                        .then(res => {
                            ...
                            if (res.status === 200) {
                                ...
                                axios.post('https://elec-shop-server.herokuapp.com/refunds', product)
                                    .then(res => {
                                        if (res.status === 200) {
    ...
    useEffect(() => {
        axios.get(`https://elec-shop-server.herokuapp.com/orders?email=${newUser?.email}`)
            .then(res => {
