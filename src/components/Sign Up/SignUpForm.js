            ...
            <form action="">
                <div className="flex flex-col space-y-4">
                    <div className="flex flex-col space-y-2">
                        ...
                        <input className="input" type="text" name="input" id="name" placeholder='John Doe' />
                    </div>
                    <div className="flex flex-col space-y-2">
                        <label htmlFor="email" className='text-gray-600 text-base'>Email</label>
                        <input className="input" type="email" name="input" id="email" placeholder='example@gmail.com' />
                    </div>
                    <div className="flex flex-col space-y-2">
                        ...
                        <input type="password" name="input" id="password" className="input" placeholder='********' />
                    </div>

                    {/* Sign button  */}
                    <div className='py-4'>
                        <button type="submit" className='py-3 px-4 w-full bg-primary text-white rounded-md hover:bg-blue-600 transition duration-300'>Sign In</button>
