    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 py-12">
            {featuresData.map(feature => (
                <Slide bottom key={feature.id}>
                    <div className="rounded-lg hover:shadow-xl transform hover:translate-y-4 overflow-hidden h-52 transition duration-500" style={{ background: `url(${feature?.image})` }}>
