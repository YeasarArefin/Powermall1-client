        ...
        <Fade right>
            <aside className='w-full md:w-96  lg:w-96 bg-secondary fixed top-0 right-0 h-screen z-50 ' style={{ height: '100%' }}>
                ...
                <div className='px-2'>
                    ...
                    {cart?.length > 0 ? (
                        <Link to='/checkout'>
                            <div className='bg-primary rounded-lg px-2 py-2  hover:bg-yellow-600 transition duration-300 w-full flex justify-between items-center cursor-pointer mt-8' onClick={ () => setShow(false)}>
