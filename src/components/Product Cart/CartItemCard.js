...
const CartItemCard = ({ handleShow}) => {
    ...
    return (
        <div className='bg-primary py-4 px-2  fixed z-40 top-2/4 right-0 rounded-tl-md rounded-bl-md shadow-xl flex flex-col space-y-2 cursor-pointer' onClick={handleShow}>
            {/* items  */}
