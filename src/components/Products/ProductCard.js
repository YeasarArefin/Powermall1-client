            ...
            <div className="rounded-lg p-4 box-border hover:translate-y-4 transform transition duration-500 h-full flex flex-col justify-between hover:shadow-xl bg-white">
                ...
                <div >
                    ...
                    <div className="flex flex-col mt-3  space-y-1">
                        <h1 className="text-base text-gray-700 font-semibold hover:underline cursor-pointer" onClick={() => navigate(`/products/${_id}`)}>{name}</h1>
                        ...
                        <div className='flex justify-between items-center pt-2'>
                            ...
                            <div >
                                ...
                                <button disabled={changeBtn} className={` ${changeBtn ? "bg-gray-200 opacity-40" : " bg-white hover:bg-gray-100"}  ring-blue-200 ring-offset-2 px-3 py-2 rounded-full border border-gray-300 text-primary focus:ring-4 transition duration-300   uppercase text-sm flex items-center space-x-1`} onClick={() => {
                                    handleClick(newProduct)
                                    setChangeBtn(true)
                                }}>
                                    <BsCartCheckFill className="text-lg" />
                                    <span className="text-sm"> {changeBtn ? "Added" : "Cart"}</span>
                                </button>
                            </div>
                        </div>
                    </div>
